<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="formulario_MERC.ascx.vb" Inherits="sspbi.formulario_MERC" %>
...
<div class="container">
      ...
      <div class="row">
          <div class="col-12">
              <p class="font-italic">  Formulario MERC</p>
          </div>
          <div class="col-6 fondoTabla text-white"><strong>Notificación MERC</strong></div>
      ...
      <div class="row">
        ...
        <div class="col-12 fondoTablaB"><strong>Identificación de la aeronave</strong></div>
            ...
            <dx:ASPxTextBox ID="ASPxTextBoxIdentificacionNumVuelo" runat="server" CssClass="form-control form-control-sm"  Width="90%"  Native="True">
            </dx:ASPxTextBox>
            ...
            <h6>Aerolínea</h6>
            <dx:ASPxTextBox ID="ASPxTextBoxOperadorAerolinea" runat="server" CssClass="form-control form-control-sm"  Width="90%"  Native="True">
            </dx:ASPxTextBox>
            ...
            <h6>Aeronave</h6>
              <dx:ASPxTextBox ID="ASPxTextBoxTipoAeronave" runat="server" CssClass="form-control form-control-sm"  Width="90%"  Native="True">
                ...
                <h6>Clase o división de la Mercancía</h6>
              <dx:ASPxTextBox ID="ASPxTextBoxClaseMercancia" runat="server" CssClass="form-control form-control-sm"  Width="90%"  Native="True">
              </dx:ASPxTextBox>
            ...
            <div class="col-md-4 fondoCuerpoB">
                ...
                <h6>MP Declarada</h6>
                  <dx:ASPxTextBox ID="ASPxTextBoxMPDeclarada" runat="server" CssClass="form-control form-control-sm"  Width="90%"  Native="True">
                  </dx:ASPxTextBox>
                 <h6>Marca UN del embalaje</h6>
                  <dx:ASPxTextBox ID="ASPxTextBoxMarcaUNembalaje" runat="server" CssClass="form-control form-control-sm"  Width="90%"  Native="True">
                  </dx:ASPxTextBox>

              
            </div>
            <div class="col-md-4 fondoCuerpoB">
              <h6>Número de UN/ID de la mercancía</h6>
              <dx:ASPxTextBox ID="ASPxTextBoxUNIDmercancia" runat="server" CssClass="form-control form-control-sm"  Width="90%"  Native="True">
              </dx:ASPxTextBox>
               
                <h6>MP Oculta</h6>
              <dx:ASPxTextBox ID="ASPxTextBoxOculta" runat="server" CssClass="form-control form-control-sm"  Width="90%"  Native="True">
              </dx:ASPxTextBox>

                 <h6>Denominacion Mercancia</h6>
              <dx:ASPxTextBox ID="ASPxTextBoxDenominacionMercancia" runat="server" CssClass="form-control form-control-sm"  Width="90%"  Native="True">
              </dx:ASPxTextBox>
...
<%--popup--%>
    <dx:ASPxPopupControl ID="ASPxPopupControl2" runat="server" Width="400px" Height="400px" ClientInstanceName="popupcontrol2" HeaderText="Formulario MERC" Theme="Glass"
