<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="reporte_voluntario_ATS.aspx.vb" Inherits="sspbi.reporte_voluntario_ATS" MasterPageFile="~/Main_Menu.Master" %>
 ...
 <div class="container">       
    ...
    <div class="row mx-auto fondoForm">
        <div class="col-xs-6 col-md-10 mt-5 mx-auto">
            <h4>Formulario de Notificacion Voluntaria ATS</h4>
            <p></p>
        </div>
...
return true;
    ...
    <dx:ASPxPopupControl ID="ASPxPopupControl2" runat="server" Width="215px" ClientInstanceName="popupcontrol2" HeaderText="Formulario Voluntario ATS" Theme="Glass"
                    ...
                    <tr>
                        <td class="auto-style34">
                             ...
                             <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                <ContentTemplate>
                                     <dx:ASPxButton ID="ASPxButton1" runat="server" Text="Inico" CssClass="btn btn-primary" Height="40px" Width="180px" Native="True">
                                       </dx:ASPxButton>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
